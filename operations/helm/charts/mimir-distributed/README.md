...
> **Note:** The documentation version is derived from the Helm chart version which is 5.7.0-weekly.350.
...
![Version: 5.7.0-weekly.350](https://img.shields.io/badge/Version-5.7.0--weekly.350-informational?style=flat-square) ![AppVersion: r350](https://img.shields.io/badge/AppVersion-r350-informational?style=flat-square)
