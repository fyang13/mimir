...
> **Note:** The documentation version is derived from the Helm chart version which is 5.7.0-weekly.373.
...
![Version: 5.7.0-weekly.373](https://img.shields.io/badge/Version-5.7.0--weekly.373-informational?style=flat-square) ![AppVersion: r373](https://img.shields.io/badge/AppVersion-r373-informational?style=flat-square)
