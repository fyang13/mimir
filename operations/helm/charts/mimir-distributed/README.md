...
> **Note:** The documentation version is derived from the Helm chart version which is 5.7.0-weekly.368.
...
![Version: 5.7.0-weekly.368](https://img.shields.io/badge/Version-5.7.0--weekly.368-informational?style=flat-square) ![AppVersion: r368](https://img.shields.io/badge/AppVersion-r368-informational?style=flat-square)
